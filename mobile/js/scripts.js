...
if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/BlackBerry/i) || 
	...
	{} else {
		window.location = 'http://www.madisonpiercing.fr';
	}
...
function initialisation() {
	if (navigator.geolocation)
		navigator.geolocation.watchPosition(function(position) {
			...
			$(".iti").attr("href", "http://maps.google.com/maps?saddr="+depart+"&daddr=18%20Rue%20de%20Guienne,%20Bordeaux");
		});
	else
